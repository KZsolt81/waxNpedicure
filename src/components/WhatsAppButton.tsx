...
export default function WhatsAppButton({ message = "Hi! I'd like to book a treatment.", label = "Message on WhatsApp", fullWidth }: Props) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center gap-3 px-7 py-4 rounded-full text-white text-sm font-medium tracking-wide transition-opacity hover:opacity-90"
      style={{
        background: "#25D366",
